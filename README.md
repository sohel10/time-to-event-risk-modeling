...
📋 Overview
This project conducts a survival analysis using publicly available lung cancer clinical trial data from Project Data Sphere. The analysis includes data integration, cleaning, Kaplan-Meier survival estimation stratified by treatment arms, log-rank tests, and Cox proportional hazards regression modeling based on age, sex, and treatment type.
